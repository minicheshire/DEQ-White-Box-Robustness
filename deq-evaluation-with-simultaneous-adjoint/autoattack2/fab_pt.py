...
from autoattack2.other_utils import zero_gradients
from autoattack2.fab_base import FABAttack
...
class FABAttack_PT(FABAttack):
    ...
    def _get_predicted_label(self, x, yy):
        with torch.no_grad():
            outputs = self._predict_fn(x, yy)
